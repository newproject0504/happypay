...
export class CustomerCreateUpdateComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.form = this.fb.group({
      ...
      description: this.defaults.description.replace(/\*/g, '\n') || '',
      ...
      specifications: this.defaults.specifications.replace(/\*/g, '\n') || '',
      instructions: this.defaults.instructions.replace(/\*/g, '\n') || '',
      termsAndConditions: this.defaults.termsAndConditions.replace(/\*/g, '\n') || '',
    });
  }
  ...
  createCustomer() {
    ...
    if (Tasktype.title && Tasktype.amount && Tasktype.taskType && Tasktype.tasksubType && Tasktype.image && Tasktype.description) {
      Tasktype.description = Tasktype.description.replace(/\n/g, '*');
      Tasktype.instructions = Tasktype.instructions.replace(/\n/g, '*');
      Tasktype.termsAndConditions = Tasktype.termsAndConditions.replace(/\n/g, '*');
      Tasktype.specifications = Tasktype.specifications.replace(/\n/g, '*');
